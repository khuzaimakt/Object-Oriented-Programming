...
void Employee::addProject(Project* Proj)
{
	...
	{
		cout << "Project is already included in " << emp_name << endl;;
		return;
	}
	...
	else if (projectcount < 2)
	{
		if (this->Pro1 == nullptr)
		{
			...
			cout << "Project added succesfully" << endl ;
...
{
	if ((emp_name == E.emp_name) && (Pro1 == E.Pro1) && (Pro2 == E.Pro2))
	{
		return true;
	}
...
void Employee::removeProject(Project* P)
{
	if (Pro1 == P)
	{
		Pro1 = nullptr;
		projectcount--;
		cout << "Project removed succesfully" << endl;
	}
